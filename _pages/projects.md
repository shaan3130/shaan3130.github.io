...
This was my course project for Machine Learning course. We implemented the idea of auto-encoding message signals by maximizing mutual information between input and output of the channel. The fascinating thing about our project was that without knowing the probability distribution of the channel, the model encoded the signal and produced accuracy similar to the QAM, the best method to encode messages. For more information please refer to the [documentation](http://shaan3130.github.io/files/project.pdf)
